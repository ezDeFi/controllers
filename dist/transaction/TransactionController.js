...
class TransactionController extends BaseController_1.default {
    ...
    getNonce(address) {
        ...
        const ethersProvider = new ethers_1.ethers.providers.JsonRpcProvider(provider.rpcTarget);
    ...
    addTransaction(transaction, origin, deviceConfirmedOn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const nonce = yield this.getNonce(transaction.from);
    ...
    stopTransaction(transactionID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ethTransaction = new ethereumjs_tx_1.default({
    ...
    speedUpTransaction(transactionID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ethTransaction = new ethereumjs_tx_1.default(Object.assign(Object.assign({}, transactionMeta.transaction), { gasPrice }));
            yield this.sign(ethTransaction, transactionMeta.transaction.from);
            const rawTransaction = ethereumjs_util_1.bufferToHex(ethTransaction.serialize());
            const transactionHash = yield util_1.query(this.ethQuery, 'sendRawTransaction', [
                rawTransaction,
    ...
    estimateGas(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let gasHex;
            try {
                gasHex = yield util_1.query(this.ethQuery, 'estimateGas', [
